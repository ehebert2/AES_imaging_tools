classdef ThresholdMaskHandler < handle
    ...
    methods
        ...
        function setChngAllSlices(obj,chngAllSlices)
            ...
            if (obj.chngAllSlices)
                for sl=1:obj.slices
                    obj.maskGenerators{sl,obj.channel}.minFeature = obj.maskGenerators{obj.slice,obj.channel}.minFeature;
                    obj.maskGenerators{sl,obj.channel}.threshold = obj.maskGenerators{obj.slice,obj.channel}.threshold;
                    obj.maskGenerators{sl,obj.channel}.setBorder(obj.maskGenerators{obj.slice,obj.channel}.border);
        ...
        function chngThreshold(obj, threshold)
            if (obj.chngAllSlices)
                for sl=1:obj.slices
