...
The code used to drive the AWG with the binary masks output by the mask app and the analysis pipeline for bloodflow analysis of the volumetric blood vessel video are also included.
...
# Bloodflow Analysis Pipeline
A step by step description, along with code samples, is included for the extraction of bloodflow kymographs from high speed AES bloodvessel volume video in conjunction with a more granular structure stack.
