...
try
    ...
    % If MEX file fails, use MATLAB implementation
    warning('eig3volume MEX file failed, using MATLAB implementation');
    [Lambda1i,Lambda2i,Lambda3i]=eig3volume_matlab(Hxx,Hxy,Hxz,Hyy,Hyz,Hzz);
end
