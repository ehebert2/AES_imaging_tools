...
ip.addParameter('kernelSize', 1 , @isnumeric); % kernelSize for erosion and dilation
ip.addParameter('VoxelSizes', [0.8702; 0.8702; 1]); %0.8702 %1.3238
ip.addParameter('minBranchLength', 20 , @isnumeric); % for the skeletonization
ip.addParameter('tau', 0.6 , @isnumeric); % controls response uniformity 0.5-1. Smaller tau extracts more segments. 
